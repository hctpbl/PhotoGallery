...
public class FlickerFetchr {
	...
	//API Key for flickr must be in the following file inside assets directory
	private static final String API_KEY_ASSET = "flickerapikey.properties";
	...
	public ArrayList<GalleryItem> fetchItems(Context context) {
		...
		try {
			is = assetManager.open(API_KEY_ASSET);
		    ...
		    Log.e(TAG, "Error retrieving Flickr API KEY.", ioe);
		} finally {
